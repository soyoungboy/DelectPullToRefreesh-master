...
public class SideslipHorScrView extends FrameLayout {
	static final int ANIMATED_SCROLL_GAP = 250;

	static final float MAX_SCROLL_FACTOR = 0.5f;

	private long mLastScroll;
	private String TAG = "SideslipHorScrView";
	...
	public SideslipHorScrView(Context context) {
		this(context, null);
	}

	public SideslipHorScrView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initScrollView();
	}
	...
	/**
	 * ����scroller�Ƿ���Ի������ݵ������¼���chileview֮�� default:false
	 * 
	 * @param b
	 *            true-����,false-����
	 */
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			if (mIsBeingDragged || scrollableOutsideTouch) {
				...
				Log.i(TAG, "  getscrollx=" + getScrollX() + "  deltax = ");
				// ȫ�������

				scrollBy(deltaX, deltaY);

				if (getScrollX() > 12 && deltaX < 0) {
					scrollTo(0, 0);
				} else if (getScrollX() > 50 && deltaX > 0) {
					scrollTo(71, 0);
				}
				{
		...
		if (mScroller.computeScrollOffset()) {
			...
			if (getChildCount() > 0) {
				...
				y = clamp(y,
						...
						child.getHeight());
				super.scrollTo(x, y);
				// getHeight()- child.getHeight()=y ->�ײ� y=0 ->����
				// ����ǿ�� mScroller.getDuration()
			}
			awakenScrollBars();
